...
def ModelX(opens,highs,lows,closes):
    if closes[-3]>opens[-3] and closes[-3]>closes[-4] and closes[-4]>opens[-4] and closes[-2]<lows[-2]+(highs[-2]-lows[-2])/4  and\
    closes[-1]>lows[-1]+(highs[-1]-lows[-1])*5/6  and highs[-3]>highs[-4] and highs[-2]>highs[-1] and lows[-3]>lows[-4] and lows[-2]>lows[-1] and \
