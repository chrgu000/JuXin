# -*- coding: utf-8 -*-
"""
Created on Mon Sep 11 11:29:02 2017
...
#                    tem1='gray'
                ...
                lines.append([[openi[i2],i],[openPrice[i2],stop12],tem])
...
candles=np.c_[opens,highs,lows,closes].tolist()
Lt=len(up10)
lines.append([list(range(Lt)),up10,'y'])
