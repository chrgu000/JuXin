...
TM=TrainModel.TrainModel(nameDB,firstTime,shufflePoints,ReGetPoints,TradeScan,dispersity,profitNot,profitOk) #should be in turn;
@TM
def ModelX(highs,lows,closes):
